...
const Header = () => {
    ...
    return (
        <Fragment>
                        ...
                        <Offcanvas.Body>
                            ...
                            >
                                ...
                                <Nav.Link
                                    as={Link}
                                    to="/petblog"
                                    className={`${styles.navLink} + ${url==="/petblog" ? styles.active : "" }`}
                                >
                                    Pet Blog
                                </Nav.Link>
                                <Nav.Link
                                ...
                                <Nav.Link
                                    as={Link}
                                    to="/login"
                                    className={`${styles.navLink} + ${url==="/login" ? styles.active : "" }`}
                                >
            ...
            {/* <div>
                <Routes>
                    <Route path="/" element={<p>Testing home</p>} />
                    <Route
                        path="/services"
                        element={<p>Testing activities</p>}
                    />
                </Routes>
            </div> */}
        </Fragment>
